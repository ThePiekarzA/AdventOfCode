...
namespace AdventOfCodeTests._10;

[TestClass]
public class PipeMazeTests
{
    [DataTestMethod]
    [DataRow(@"10\testInput1.txt", 4)]
    [DataRow(@"10\testInput2.txt", 8)]
    ...
    [DataTestMethod]
    [DataRow(@"10\testInput1.txt", 1)]
    [DataRow(@"10\testInput2.txt", 1)]
    [DataRow(@"10\testInput3.txt", 4)]
    [DataRow(@"10\testInput4.txt", 8)]
    [DataRow(@"10\testInput5.txt", 10)]
